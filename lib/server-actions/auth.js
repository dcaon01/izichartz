...
export async function userRegister(prevState, formData) {
    ...
    const insertActivationCodeQuery = 'INSERT INTO "CONFIRM_CODES"("user", "code", "slug", "expires") VALUES($1, $2, $3, $4)';
    let result = null;
    let slug = null;
    let code = null;
    ...
    try {
        ...
        /* 
            Creazione del record nella tabella CONFIRM_CODES per i codici di verifica relativi all'utente.
            Cominciamo con il code e l'hashing dello stesso.
        */
        ...
        /* Generiamo lo slug */
        slug = generateRandomSlug(32);
        const hashedSlug = await hash(slug);
        insertActCodValues.push(hashedSlug);
 ...
 * @param length lunghezza dello slug alfanumerico randomico.
 ...
 * @param length lunghezza del codice numerico randomico.
