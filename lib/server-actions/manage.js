...
export async function createProject(prevState, formData) {
    ...
    const insertProjectQuery = 'INSERT INTO "PROJECTS"("name", "owner", "module", "content", "creation", "lastModified", "preview") VALUES ($1, $2, $3, $4, $5, $6, $7)';
    ...
    try {
        ...
        await client.query(insertProjectQuery, [name, value.email, module, {}, date, date, "/assets/design/workpane-bg.png"]);
